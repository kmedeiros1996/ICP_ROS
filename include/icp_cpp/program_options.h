...
ProgramOptions ParseArgs(int argc, char** argv) {
  ...
  options.add_options()
    ...
    ("enable_publishing", "enable publishing of all messages (Disable only for unit testing or debug)",
    cxxopts::value<bool>(program_options.enable_publishing)->default_value("true"))
    ("enable_subscribing", "enable subscription to topics (Disable only for unit testing or debug)",
    cxxopts::value<bool>(program_options.enable_subscribing)->default_value("true"))
